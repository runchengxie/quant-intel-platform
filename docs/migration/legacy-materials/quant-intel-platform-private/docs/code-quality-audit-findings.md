...
截至 2026-09-08，`scripts/dev/maintainability_metrics.py --json --ratchet` 报告 89 个超过 100 列的长行、6 个超过 100 行的函数、2 个超过 800 行的文件和 0 个行内 `C901` 忽略项。当前 ratchet 已通过，后续治理应以这组指标和实际 CI 配置为准。
